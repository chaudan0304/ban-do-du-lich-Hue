...
## 🛠️ Hướng dẫn vận hành hệ thống (Workflow)

Để hệ thống hoạt động chính xác với dữ liệu mới nhất, cần chạy các script theo đúng thứ tự sau:

### Bước 1: Chuẩn bị dữ liệu gốc

Tạo file Excel chứa danh sách địa điểm và User mẫu.
