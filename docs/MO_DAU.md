...
- Các địa điểm du lịch tiêu biểu tại thành phố Huế và vùng phụ cận.
...
- **Phạm vi nội dung:**
  - Xây dựng hệ thống gợi ý du lịch dựa trên Graph Database.
  - Triển khai và đánh giá các thuật toán AI Recommendation.
  - Xây dựng tính năng lập lộ trình tự động.
  - *Không bao gồm:* Đặt phòng khách sạn, vé máy bay, thanh toán trực tuyến.
...
### 4.3. Phương pháp Phân tích và Thiết kế
...
### 4.4. Phương pháp Triển khai và Đánh giá
