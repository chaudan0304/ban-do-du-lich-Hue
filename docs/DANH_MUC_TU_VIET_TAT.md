...
| CSS | Cascading Style Sheets | Bảng định kiểu xếp tầng |
| DAL | Data Access Layer | Tầng truy cập dữ liệu |
| GCN | Graph Convolutional Networks | Mạng nơ-ron tích chập đồ thị |
| GDS | Graph Data Science | Khoa học dữ liệu đồ thị |
...
| JS | JavaScript | Ngôn ngữ kịch bản JavaScript |
...
| XAI | Explainable AI | Trí tuệ nhân tạo có thể giải thích |
